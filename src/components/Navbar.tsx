      ...
      <nav className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-7">
        ...
        <div className="flex items-center justify-between min-h-[90px] py-2">
          ...
          <div className="hidden lg:flex flex-1 justify-center items-center">
            ...
            <div className="flex items-center gap-5 xl:gap-4">
              ...
              <Link
              to="/register"
              className="ml-1 px-3 py-2 text-[13px] font-semibold text-white rounded-md bg-gradient-to-r from-green-600 to-green-500 shadow hover:shadow-md transition-all duration-300 whitespace-nowrap"
              >
                Register
                </Link>
                {/* SUBMIT BUTTON */}
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden border-t border-gray-200 bg-white">
          ...
          <div className="px-4 py-4 space-y-2">
            ...
            <Link
              to="https://easychair.org/account/signin?l=1462013209260267560.1779723204.90191373"
              target="_blank"
              rel="noopener noreferrer"
